package ramirez.bracamontes.nallely.guessthenumber
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //intancia al objeto de layout guessings
        val guessing: TextView =findViewById(R.id.guessings)
        val down: Button =findViewById(R.id.down)
        val up: Button =findViewById(R.id.up)
        val generete: Button =findViewById(R.id.generate)
    ...
    guessed.setOnClickListener{
        if(!won){
            guessing.setText("Adiviné, tú numero es el "+ num)
            guessed.setText("Volver a jugar")
            won= true
        }else{
            generete.visibility = View.VISIBLE
